...
// 3. 32 Negocios con FOTOS 100% ÚNICAS Y ENFOCADAS EN CADA CATEGORÍA REAL
$negocios = [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 490,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=800&auto=format&fit=crop&q=80', // Queso artesanal
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 680,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=800&auto=format&fit=crop&q=80', // Pescado frito
        'prods' => [
    ...
    [
        ...
        'descripcion' => 'Auténtico asado huilense horneado en tiesto de barro con insulso, arepa de choclo, tamales yaguareños y carnes al carbón.',
        'direccion' => 'Calle 8 # 3-15, Barrio Las Ferias, Yaguará',
        'telefono' => '3109876543', 'whatsapp' => '3109876543',
        'verificado' => 1, 'destacado' => 1, 'visitas' => 420,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800&auto=format&fit=crop&q=80', // Asado / costillas
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 520,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&auto=format&fit=crop&q=80', // Panadería artesanal / galletas
        'prods' => [
    ...
    [
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&auto=format&fit=crop&q=80', // Pan recién horneado
        'prods' => [
    ...
    [
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?w=800&auto=format&fit=crop&q=80', // Supermercado víveres
        'prods' => [
    ...
    [
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&auto=format&fit=crop&q=80', // Tienda de conveniencia
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 430,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1586015555751-63bb77f4322a?w=800&auto=format&fit=crop&q=80', // Farmacia estantes
        'prods' => [
    ...
    [
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=800&auto=format&fit=crop&q=80', // Medicamentos & cuidado
        'prods' => [
    ...
    // 10: Servicios Técnicos Don Hernán
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 320,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&auto=format&fit=crop&q=80', // Electricista / motor
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 810,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop&q=80', // Cabañas con piscina
        'prods' => [
    ...
    // 12: Hotel Colonial Yaguará Plaza
    [
        ...
        'verificado' => 1, 'destacado' => 0, 'visitas' => 360,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800&auto=format&fit=crop&q=80', // Habitación hotel
        'prods' => [
            ['Habitación Matrimonial Climatizada con Desayuno', 'Cama queen, TV Smart, baño privado y aire acondicionado.', 90000, 'Noche']
        ]
    ],

    // 13: Café & Heladería Dulce Placer
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 590,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800&auto=format&fit=crop&q=80', // Café & helado
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=800&auto=format&fit=crop&q=80', // Taller motos
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&auto=format&fit=crop&q=80', // Ferretería / construcción
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800&auto=format&fit=crop&q=80', // Silla de barbería
        'prods' => [
            ['Corte de Cabello Moderno + Perfilado de Barba', 'Incluye lavado, diseño y aplicación de loción refrescante.', 22000, 'Servicio']
        ]
    ],

    // 17: Agropecuaria El Ganadero
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 460,
        'latitud' => '2.6612', 'longitud' => '-75.5185',
        'logo' => 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1516467508483-a7212febe31a?w=800&auto=format&fit=crop&q=80', // Ganadería / veterinaria
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 0, 'visitas' => 370,
        'latitud' => '2.6627', 'longitud' => '-75.5220',
        'logo' => 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=800&auto=format&fit=crop&q=80', // Cortes de carne fresca
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=800&auto=format&fit=crop&q=80', // Frutas tropicales
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800&auto=format&fit=crop&q=80', // Cerámica artesanal
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 620,
        ...
        'imagen_portada' => 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=800&auto=format&fit=crop&q=80', // Pizza horneada
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 0, 'visitas' => 430,
        'latitud' => '2.6618', 'longitud' => '-75.5195',
        'logo' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=800&auto=format&fit=crop&q=80', // Pollo asado crocante
        'prods' => [
    ...
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 710,
        'latitud' => '2.6865', 'longitud' => '-75.4835',
        'logo' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1543353071-873f17a7a088?w=800&auto=format&fit=crop&q=80', // Sancocho / comida campestre
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1622597467836-f3285f2131b7?w=800&auto=format&fit=crop&q=80', // Jugos naturales
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1534723452862-4c874018d66d?w=800&auto=format&fit=crop&q=80', // Tienda camping / bebidas
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1581244277943-fe4a9c777189?w=800&auto=format&fit=crop&q=80', // Plomero herramientas
        'prods' => [
            ['Servicio de Destape de Cañería con Sonda', 'Atención rápida sin romper pisos ni paredes.', 50000, 'Servicio']
        ]
    ],

    // 27: Papelería Central
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1588072432836-e10032774350?w=800&auto=format&fit=crop&q=80', // Papelería / libros
        'prods' => [
            ['Paquete de Hojas de Papel Bond Resma 500 Hojas', 'Papel reprograf para oficina y colegio.', 18000, 'Resma']
        ]
    ],

    // 28: Llantas & Serviteca
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?w=800&auto=format&fit=crop&q=80', // Serviteca / llantas
        'prods' => [
            ['Despinche y Calibración con Nitrógeno (Carro / Camioneta)', 'Despinche con mecha o parche vulcanizado al calor.', 15000, 'Servicio']
        ]
    ],

    // 29: Glamping El Remanso
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 960,
        'latitud' => '2.6750', 'longitud' => '-75.4950',
        'logo' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1587061949409-02df41d5e562?w=800&auto=format&fit=crop&q=80', // Glamping con jacuzzi
        'prods' => [
            ['Noche Domo Glamping Deluxe Pareja con Jacuzzi', 'Incluye cena especial, botella de vino y desayuno campesino.', 320000, 'Noche']
        ]
    ],

    // 30: Fábrica Lácteos Don Ramiro
    [
        ...
        'verificado' => 1, 'destacado' => 1, 'visitas' => 540,
        'latitud' => '2.6633', 'longitud' => '-75.5219',
        'logo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=800&auto=format&fit=crop&q=80', // Lácteos & leche fresca
        'prods' => [
    ...
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&auto=format&fit=crop&q=80', // Torta de cumpleaños
        'prods' => [
            ['Torta de Cumpleaños Tres Leches con Frutas (1 Libra)', 'Decorada con fresas, duraznos y chocolate.', 45000, 'Torta']
        ]
    ],

    // 32: Comidas Rápidas Los Amigos
    [
        ...
        'logo' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
        'imagen_portada' => 'https://images.unsplash.com/photo-1561758033-d89a9ad46330?w=800&auto=format&fit=crop&q=80', // Hamburguesa & papas
        'prods' => [
...
echo "¡Se insertaron 32 comercios y 55 productos con fotos únicas y personalizadas para cada categoría!\n";
